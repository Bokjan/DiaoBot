...
class DylibManagerImpl {
  ...
  DylibManagerImpl(void) : AI_LibID(1) {}
};

DylibManager::DylibManager(void) { PImpl = new DylibManagerImpl; }

DylibManager::~DylibManager(void) { delete PImpl; }

DylibManager &DylibManager::GetInstance(void) { return DylibManager::Instance; }
