...
class CallbackMessage {
 public:
  ...
  enum ChatTypeEnum { UNKNOWN_CHAT_TYPE, SINGLE, GROUP };

  enum MsgTypeEnum { UNKNOWN_MSG_TYPE, TEXT, EVENT, ATTACHMENT };
...
class CallbackEventMessage : public CallbackMessage {
 public:
  ...
  enum EventTypeEnum { UNKNOWN_EVENT, ADD_TO_CHAT, DELETE_FROM_CHAT, ENTER_CHAT };
